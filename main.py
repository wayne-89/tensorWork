...
# generate TFrecord
os.system(
    'python {0}/generate_tfrecord.py --csv_input={1}/images/train_labels.csv --image_dir={1}/images/train --output_path={1}/train.record --label_map_path={2}'.format(
        basePath, dstPath, cfgPath))
os.system(
    'python {0}/generate_tfrecord.py --csv_input={1}/images/test_labels.csv --image_dir={1}/images/test --output_path={1}/test.record --label_map_path={2}'.format(
        basePath, dstPath, cfgPath))
...
# start train
os.system(
    'python {0}/train.py --logtostderr --train_dir={1}/training/ --pipeline_config_path={2}'.format(basePath, dstPath,
                                                                                                    dstConfigPath))
# clean output
