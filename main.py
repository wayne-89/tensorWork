...
os.system('python {0}/img_enhance.py --PATH_TO_IMAGE_DIR {1}/images/train --PATH_TO_LABELS {1}/images/train_labels.csv  --NEW_PATH_TO_IMAGE_DIR {1}/images/train_out -DEBUG_ON True --OPERATES {2}'.format(basePath, dstPath,operatesArg))
...
os.system('python {0}/img_enhance.py --PATH_TO_IMAGE_DIR {1}/images/test --PATH_TO_LABELS {1}/images/test_labels.csv  --NEW_PATH_TO_IMAGE_DIR {1}/images/test_out -DEBUG_ON True --OPERATES {2}'.format(basePath, dstPath,operatesArg))
